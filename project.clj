(def jetty-version "12.0.24")
(def ring-version "1.14.2")

(defproject info.sunng/ring-jetty9-adapter "0.37.6-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.12.1"]
                 ...
                 [info.sunng/ring-jetty9-adapter-http2 "0.1.10" :optional true]
                 [info.sunng/ring-jetty9-adapter-http3 "0.6.10" :optional true]
